...
function nodeobsidian(options) {
    ...
    self.api.campaign = {
        ...
        characters: {
            ...
            create: function (campaignid, characterdata, format, callback) {
                _api_putOrPost('campaigns/' + campaignid + '/characters', 'json', characterdata, callback);
            },
            update: function (campaignid, characterid, characterdata, format, callback) {
                _api_putOrPost('campaigns/' + campaignid + '/characters/' + characterid, 'json', characterdata, callback);
            },
        ...
        wikis: {
            ...
            create: function (campaignid, wikidata, format, callback) {
                _api_putOrPost('/campaigns/' + campaignid + '/wikis', 'json', wikidata, callback);
            },
            update: function (campaignid, wikiid, wikidata, format, callback) {
                _api_putOrPost('/campaigns/' + campaignid + '/wikis/' + wikiid, 'json', wikidata, callback);
            },
    ...
    self.api.dst = {
        ...
        update: function (dstid, dstdata, format, callback) {
            _api_putOrPost('/dynamic_sheet_templates/' + dstid, 'json', dstdata, callback);
        },
        submit: function (dstid, format, callback) {
            _api_putOrPost('/dynamic_sheet_templates/' + dstid + '/submit', 'json', {}, callback);
        }
    };
